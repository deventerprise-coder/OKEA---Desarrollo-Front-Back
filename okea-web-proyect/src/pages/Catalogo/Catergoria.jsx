...
export default function Categoria({categoria, subcategoria}) {
  ...
  return (
    <>
      <BreadCrum categoria={categoria} subcategoria={subcategoria} />
      <Panel Categoria={categoria} destacados={destacadoList}/>
      <div className="flex mt-40">
        <SidebarMenu categoria={categoria} subcategoria={subcategoria}/>
        <aside className="flex flex-col items-center">
          <Products products={productosList} categoria={categoria}/>
        </aside>
      </div>
