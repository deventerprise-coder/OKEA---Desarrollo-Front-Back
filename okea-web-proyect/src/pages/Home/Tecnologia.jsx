        ...
        <div className="mt-4 md:mt-16 items-center flex flex-col justify-center px-4 sm:px-6/12 md:3/12 lg:px-40">
          ...
          {/*Contenido fila 2 responsive*/}
           <div className=" mt-4 md:hidden flex overflow-hidden bg-cover w-full rounded-2xl h-24 md:h-80 ml:h-80" style={{ backgroundImage: `url(${tecnologiaImagen6})` }} ></div>
            ...
            <div className="mx-40 mt-4 w-full h-98 lg:h-60 xl:h-70 2xl:h-100 mt-4">
                <div className=" h-98  xl:h-100 md:grid md:grid-cols-2 gap-4 "> 
                    <div className="relative overflow-hidden pt-10 px-2 xl:px-7 bg-[#B1C5FF] h-48 lg:h-60 xl:h-70 2xl:h-100 rounded-2xl md:rounded-4xl">
                        ...
                        {/*imagen*/}
                        <div className="absolute bg-cover -bottom-48.5 md:-bottom-35.5 lg:-bottom-45 xl:-bottom-40 2xl:-bottom-30 -right-75  2xl:-right-54 w-200 h-124 scale-22 md:scale-30 xl:scale-40 2xl:scale-52" style={{ backgroundImage: `url(${tecnologiaImagen1})` }}></div>
                    </div>
                    {/*cuadro derecho*/}
                    <div className="relative py-8 px-10 h-48 lg:h-60 xl:h-70 2xl:h-100 mt-4 md:mt-0  bg-contain bg-no-repeat rounded-2xl md:rounded-4xl bg-[#e35944] " style={{ backgroundImage: `url(${tecnologiaImagen5})` }}>
            ...
            {/*Contenido fila 2*/}
           <div className=" mt-4 hidden md:flex overflow-hidden bg-cover bg-no-repeat  w-full rounded-2xl h-24 md:h-100 " style={{ backgroundImage: `url(${tecnologiaImagen6})` }} ></div>
